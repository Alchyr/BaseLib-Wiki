...
* Use `GodotUtils.CreatureVisualsFromImage` to convert a `.png` or other common image format into an `NCreatreVisuals` instance. If using this for a character, override `CreateCustomVisuals` and return this.
